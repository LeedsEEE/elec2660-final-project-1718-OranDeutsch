...
@implementation SavedDebts

@synthesize IOweDebt =  _IOweDebt;
@synthesize ImOwedDebt =  _ImOwedDebt;

static SavedDebts *_sharedInstance;
...
{
    if (!_sharedInstance) {
        _sharedInstance = [[SavedDebts alloc] init];
    }
